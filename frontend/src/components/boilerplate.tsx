...
import { GithubIcon, LogOut, User } from "lucide-react";
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="group p-8 border border-border/50 rounded-2xl bg-gradient-to-br from-background to-muted/20 transition-all duration-500">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Clean, intuitive architecture with TypeScript support, modern
                tooling, and a codebase that scales effortlessly with your
                project.
              </p>
            </div>
          </div>
